    ...
    <nav class="navbar navbar-expand-lg customNav">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <ul class="navbar-nav ml-auto customNavGroup">
                <li class="nav-item">
                    <a class="nav-link nav-link-txt customNavFont" href="">About</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-txt customNavFont">Articles</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-txt customNavFont">Podcast</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-txt customNavFont">Free Resources</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-txt customNavFont">Contact</a>
                </li>
            </ul>
        </div>
    </nav>
